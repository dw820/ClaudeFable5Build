...
[`prd.md`](https://github.com/dw820/ClaudeFable5Build/blob/main/prd.md) is the contract. Its top section `## 0. Scope Lock` **explicitly
...
[`CLAUDE.md`](https://github.com/dw820/ClaudeFable5Build/blob/main/CLAUDE.md) and persistent memory carry the things that would silently
...
Visual specs live in [`docs/`](https://github.com/dw820/ClaudeFable5Build/tree/main/docs/): [`loop-controller-spec.html`](https://github.com/dw820/ClaudeFable5Build/blob/main/docs/loop-controller-spec.html),
[`loop-vs-agent-spec.html`](https://github.com/dw820/ClaudeFable5Build/blob/main/docs/loop-vs-agent-spec.html),
[`architecture-flow.html`](https://github.com/dw820/ClaudeFable5Build/blob/main/docs/architecture-flow.html).

### 4. Reproducible "autonomous run" scaffolding
So that "autonomous" meant *reproducible*, not *lucky*:
- [`scripts/daytona-provision.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/scripts/daytona-provision.ts) + [`scripts/daytona-setup.sh`](https://github.com/dw820/ClaudeFable5Build/blob/main/scripts/daytona-setup.sh) — spin up a clean sandbox the agent runs in.
- [`scripts/smoke-real-tools.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/scripts/smoke-real-tools.ts) — exercise the real ffmpeg + real LLM path, not stubs.
- [`scripts/make-fixture.mjs`](https://github.com/dw820/ClaudeFable5Build/blob/main/scripts/make-fixture.mjs) + [`scripts/fetch-clips.mjs`](https://github.com/dw820/ClaudeFable5Build/blob/main/scripts/fetch-clips.mjs) — committed fixture clip library so tests never depend on live preprocessing.

### 5. Pre-bake the expensive, off-path work
Preprocessing ([`src/preprocess/`](https://github.com/dw820/ClaudeFable5Build/tree/main/src/preprocess/)) was built as first-class,
...
[`src/loop/controller.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/controller.ts) header:
...
[`src/loop/controller.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/controller.ts) runs `build → render → grade`,
...
injected dependencies ([`src/loop/deps.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/deps.ts)), so the loop is fully
unit-tested without ffmpeg or Claude ([`controller.test.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/controller.test.ts),
[`integration.test.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/integration.test.ts)). A stubbed, runnable proof of
termination lives in [`src/loop/demo.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/demo.ts).

### 2. The builder agent
[`src/agent/`](https://github.com/dw820/ClaudeFable5Build/tree/main/src/agent/) + [`src/builder/`](https://github.com/dw820/ClaudeFable5Build/tree/main/src/builder/) — the agent reads
...
[`src/verify/grade.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/verify/grade.ts) is **Lane C**: a *fresh agent in
isolated context*. It extracts keyframes from the rendered video and scores them
against [`rubrics/viral-short.json`](https://github.com/dw820/ClaudeFable5Build/blob/main/rubrics/viral-short.json) — and it is
...
[`rubrics/viral-short.json`](https://github.com/dw820/ClaudeFable5Build/blob/main/rubrics/viral-short.json) — `hook_strength`,
...
([`src/memory/`](https://github.com/dw820/ClaudeFable5Build/tree/main/src/memory/) — `distill.ts` / `consult.ts`), consulted on the next
...
Key files — brief: [`prd.md`](https://github.com/dw820/ClaudeFable5Build/blob/main/prd.md) · rubric: [`rubrics/viral-short.json`](https://github.com/dw820/ClaudeFable5Build/blob/main/rubrics/viral-short.json) ·
controller: [`src/loop/controller.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/loop/controller.ts) · verifier:
[`src/verify/grade.ts`](https://github.com/dw820/ClaudeFable5Build/blob/main/src/verify/grade.ts) · scripts: [`scripts/`](https://github.com/dw820/ClaudeFable5Build/tree/main/scripts/).
